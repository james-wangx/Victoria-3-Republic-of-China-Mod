...
- 替换原版 **汉阳兵工厂**：核心建筑为兵工厂、弹药厂与炸药厂，火炮厂改为扩展建筑；科技条件改为“栓动式步枪”，增益为陆军进攻 +10%、防御 +10%，名贵商品为“汉阳造步枪”与“高级炸药”。
- 替换原版 **江南织造局**：棉花种植园改为基础建筑，染料作物种植园为扩展建筑，增益改为纺织厂 +10%、丝绸种植园 +10%。
- 替换原版 **福州船政局**：核心建筑为造船厂，扩展建筑为动力机械厂，增益为补给船建造效率 +10%、造船厂吞吐量 +10%。
...
- 新增中国专属的 **延长石油公司**（`company_roc_yanchang_petroleum`）：建筑为油田，扩展行业为发电厂，增益为油田吞吐量 +20%；陕西为已整合地区且油田达到 5 级即可成立。
...
- 新增中国专属的 **轮船招商局**（`company_roc_china_merchants`）：建筑为贸易中心与港口，扩展行业为造船厂，名贵商品为高速商船，增益为贸易优势 +10%、港口 +10%；苏州为已整合地区且贸易中心与港口均达到 5 级即可成立。
- 新增中国专属的 **江南制造局**（`company_roc_jiangnan_arsenal`）：建筑为动力机械厂与工艺装备工坊，扩展行业为汽车厂，名贵商品为江南发动机与精密工具，增益为主力舰建造效率 +10%、动力机械厂吞吐量 +10%；苏州为已整合地区且动力机械厂达到 5 级即可成立。
