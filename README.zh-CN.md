...
- 新增中国专属的 **泰康食品公司**（`company_roc_taikang_foods`）：建筑为食品厂，扩展行业为渔业码头，名贵商品为精品加工食品，增益为食品厂 +10%、贸易优势 +10%；研究“罐装机”科技后，山东或苏州的已整合地区食品厂达到 5 级即可成立。
- 新增中国专属的 **延长石油公司**（`company_roc_yanchang_petroleum`）：建筑为油田，增益为油田吞吐量 +20%；陕西为已整合地区且油田达到 5 级即可成立。
- 新增中国专属的 **上海电气公司**（`company_roc_shanghai_electric`）：建筑为发电厂与铁路，扩展行业为电子厂，增益为发电厂 +10%、铁路 +10%；苏州为已整合地区且发电厂达到 5 级即可成立。
- 新增中国专属的 **上海机器造纸局**（`company_roc_shanghai_paper`）：建筑为造纸厂，扩展行业为伐木营地，名贵商品为工艺纸品，增益为造纸厂 +10%、行政力 +10%；研究“机械工具”科技后，苏州为已整合地区且造纸厂达到 5 级即可成立。
- 新增中国专属的 **轮船招商局**（`company_roc_china_merchants`）：建筑为贸易中心与港口，名贵商品为高速商船，增益为贸易优势 +10%、港口 +10%；苏州为已整合地区且贸易中心与港口均达到 5 级即可成立。
- 新增中国专属的 **江南制造局**（`company_roc_jiangnan_arsenal`）：建筑为动力机械厂，扩展行业为工艺装备工坊，名贵商品为江南造蒸汽机，增益为主力舰建造效率 +10%、动力机械厂吞吐量 +10%；苏州为已整合地区且动力机械厂达到 5 级即可成立。
